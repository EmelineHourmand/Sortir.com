...
public abstract class RegExpPatterns {
    ...
    public static final String TYPE_SQL_STRING_50_PATTERN = "^(.){1,50}$";
    // Une String de 1 à 255 char
    public static final String TYPE_SQL_STRING_255_PATTERN = "^(.){1,255}$";
    ...
    // Postal code
    public static final String POSTAL_CODE_PATTERN = "^((0[1-9])|([1-8][0-9])|(9[0-8])|(2A)|(2B))[0-9]{3}$";
    ...
    // IP addresse v4
    public static final String IPV4_PATTERN = "^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5]).){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])$";
    // IP addresse v6
    ...
    // URL
    public static final String URL_PATTERN = "^http(s)?://[a-z0-9-]+(.[a-z0-9-]+)*(:[0-9]+)?(/.*)?$";
